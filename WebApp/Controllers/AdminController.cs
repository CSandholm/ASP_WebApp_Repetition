...
namespace WebApp.Controllers
{
    public class AdminController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Color,OwnerName,Age,ImageUrl")] Cat cat)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Color,OwnerName,Age,ImageUrl")] Cat cat)
        {
            if (id != cat.Id)
            {
                return NotFound();
